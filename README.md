...
<picture>
  <source media="(prefers-color-scheme: dark)"  srcset="docs/assets/hero-en-dark.png?v=3">
  <source media="(prefers-color-scheme: light)" srcset="docs/assets/hero-en-light.png?v=3">
  <img width="880" src="docs/assets/hero-en-light.png?v=3"
       alt="Webpage OS. Describe your business; Claude builds the site. No code, no templates, a live URL in minutes. A terminal shows the tool run for a bakery and the finished page live on a Vercel URL. 21 bundled skills, 6 guided phases, 0 lines you write.">
</picture>
...
[![License MIT](https://img.shields.io/github/license/adrianbigsimple/Webpage-OS?style=flat-square&label=license&labelColor=2A241D&color=C2562F)](LICENSE)
...
You now have the project on your computer inside a folder called `Webpage-OS`.
...
The bundled skills in `.claude/skills/` carry their own upstream licenses and notices.
See [.claude/skills/ATTRIBUTION.md](.claude/skills/ATTRIBUTION.md) for the full list.

---

Created by [@adrianbigsimple](https://github.com/adrianbigsimple)
